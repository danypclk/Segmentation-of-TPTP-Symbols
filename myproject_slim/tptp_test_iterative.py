...
# Iterative function to classify parameters inside a function (like a predicate)
    ...
    while i < length:
        ...
        # End of a function (when encountering ')')
            ...
            if paren_count == 0:
                ...
                current_function = []  # Reset for the next function
...
# Helper function to extract the name of the function and classify its parameters iteratively
def extract_function_name_and_parameters(function_string):
    ...
    if function_match:
        ...
        # Classify parameters iteratively (no recursion)
